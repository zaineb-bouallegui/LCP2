 ...
 */
export async function JavaScript_action_uploadFile1(doc1) {
	// BEGIN USER CODE
        ...
        fileInput.addEventListener('change', function () {
            ...
            fr.onload = function () {
               // console.warn(fr.result);
                //console.warn(files.files[0].name); // Log the file name
               ...
               // console.warn(fileType);
                // console.warn(base64Content);
                doc1.set("nom", fileName);
                doc1.set("_type", fileType);
                doc1.set("contenu", base64Content);
